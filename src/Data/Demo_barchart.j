...
const Demo_barchart = () => {
  const [viz_BarChart, setViz_BarChart_Data] = useState(null);
  ...
  version: "1.1",
      ...
      rawData: [
        ...
        [
          ...
          "Science fictionanthology series",
          "2016",
          "Renewed",
          "1",
          "6",
        ...
        [
          "Drama",
          "The Last Kingdom (season 2) (co-production with BBC Two)",
          "Period drama",
          "2017",
          "Pending",
          "1",
        ...
        [
          "Family Animation",
          "DreamWorks Dragons (seasons 3, 4, 5 and 6)",
          "Animation",
          "2015",
          "Pending",
          "4",
      ...
      visualOptions: {
        ...
        colorScale: {
          ...
          userScaleValues: [{ range: "#1f77b4", domain: "default" }],
          defaultColor: "#cccccc",
        },
      },
    };

const rows_BarChart = BarChart.userInput.split('\n');

const columns_BarChart = rows_BarChart[0].split('\t');

const Result_BarChart = rows_BarChart.slice(1).map(row => {
  const rowData = row.split('\t');
  const obj = {};
  columns_BarChart.forEach((key, index) => {
...
const mapping_BarChart = BarChart.mapping;

const viz_BarChart = chart(barchart, { data: Result_BarChart, mapping: mapping_BarChart });

console.log(viz_BarChart);

setViz_BarChart_Data(viz_BarChart);

}, []);

return (
  <div>
    <Render_graph viz_BarChart={viz_BarChart} />
  </div>
);
}


export default Demo_barchart;